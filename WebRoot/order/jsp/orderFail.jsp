...
<jsp:include page="${path}/common/jsp/com_top.jsp"></jsp:include>
			...
			<div class="message">
				...
				<div class="img">
					<div class="img2">
						...
						<input type="button" value="样品查看" class="see">
						</div>
				</div>
			</div>
			<div class="line"></div>
	...
	<div class="bott">
		<div class="info">
			<label class="font_info">支付不成功，请重新确认！</label>
		</div>
		<div class="bt">
			<input type="button" value="付款" class="button3" onclick="new commonUtil().fnToPage('/personal/jsp/personal.jsp');">
		</div>
	</div>
